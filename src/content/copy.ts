...
export const COPY: Record<Lang, Copy> = {
  es: {
    ...
    trust: ["Mínimo 50 plantas", "Solo Tillandsia bulbosa", "Mezcla tallas libremente", "[Cultivadas por Proyecto Indigo Azul: por confirmar]"],
    ...
    originTitle: "Una especie nativa de México",
    origin: [
      ...
      "Las plantas de Tila crecen en Proyecto Indigo Azul, en Puerto Vallarta. [Descripción del proyecto: por confirmar].",
  ...
  en: {
    ...
    trust: ["50-plant minimum", "Tillandsia bulbosa only", "Mix sizes freely", "[Grown by Proyecto Indigo Azul: to be confirmed]"],
    ...
    originTitle: "A species native to Mexico",
    origin: [
      ...
      "Tila plants grow at Proyecto Indigo Azul in Puerto Vallarta. [Project description: to be confirmed].",
